...
// This nested function is an example of closure. Closure is the ability of a child level scope to reach up into the parent level scope and have access to functions and variables.
...
const zooAnimals = [
  ...
  */
  function USApop(zooAnimals){
    let totalPop = zooAnimals.reduce(function(acc, item){
